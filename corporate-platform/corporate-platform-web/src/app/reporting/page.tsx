...
export default function ReportingPage() {
  ...
  const reportTemplates = [
    ...
    {
      name: "Carbon Neutrality Statement",
      framework: "ISO 14064",
      duration: "20 min",
      icon: Target,
    },
    ...
    {
      name: "Sustainability Disclosure",
      framework: "SASB",
      duration: "40 min",
      icon: FileText,
    },
  ...
  const publishedReports = availableReports.filter(
    (r) => r.status === "published",
  ).length;
  const avgPages = Math.round(
    availableReports.reduce((sum, r) => sum + r.pages, 0) / totalReports,
  );
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between">
          <div className="mb-6 lg:mb-0">
            ...
            <p className="text-blue-100 opacity-90 max-w-2xl">
              Generate comprehensive sustainability reports, track ESG
              performance, and automate stakeholder communications.
            </p>
          </div>
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Overall ESG score and category performance
                </p>
              </div>
              <div className="flex items-center">
                <div className="text-2xl font-bold text-corporate-blue mr-2">
                  85.7
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-400">
                  /100 Overall Score
            ...
            <div className="corporate-card p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-sm text-gray-600 dark:text-gray-400">
                    Create a new ESG performance report
                  </p>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {["Q1 2024", "Q2 2024", "2023 Annual", "Custom Range"].map(
                      (period) => (
                        <button
                          key={period}
          ...
          <div className="corporate-card p-6">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Emissions reduction trajectory vs. targets
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-4 bg-linear-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg">
                <div className="text-2xl font-bold text-purple-600 mb-1">
                  {(portfolio.totalRetired ?? 0).toLocaleString()}
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-400">
                  tCO₂ retired to date
                </div>
      ...
      <div className="corporate-card p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Generated and draft reports ready for distribution
            </p>
          </div>
          <div className="flex items-center space-x-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {reportTemplates.map((template, index) => {
            ...
            return (
              <div
                key={index}
                className="p-4 border border-gray-200 dark:border-gray-800 rounded-lg hover:border-corporate-blue/50 hover:shadow-md transition-all duration-300"
              >
        ...
        <div className="corporate-card p-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <div
                key={index}
                className="p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg text-center hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors cursor-pointer"
              >
                <div
                  className={`${item.color} w-12 h-12 rounded-lg flex items-center justify-center mx-auto mb-3`}
                >
