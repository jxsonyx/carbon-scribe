    ...
    <div className="corporate-card p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Monthly carbon credit activity
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        {[
          {
            label: "Total Value",
            value: `$${((portfolio.totalSpent ?? 0) / 1000).toFixed(1)}K`,
            icon: DollarSign,
            change: "+8.2%",
            trend: "up",
          },
          {
            ...
            value: `${((portfolio.totalRetired ?? 0) / 1000).toFixed(1)}K`,
            icon: TrendingUp,
            change: "+12.5%",
            trend: "up",
          },
          {
            label: "SDG Impact",
            value: `${Object.keys(portfolio.sdgContributions ?? {}).length}`,
            icon: Globe,
            change: "+3",
            trend: "up",
          },
